 ...
 * @author Jonathan Gil
 */
public class ContraseñaConUsuario extends javax.swing.JDialog {

    EmpleadosDao emple = new EmpleadosDao();
    boolean contraseñaAceptada = false;
    int eleccion = -1;

    public ContraseñaConUsuario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void cambiandoEncabezado(int eleccion) {
        this.eleccion = eleccion;
        switch (eleccion) {
            case 1:
                this.setTitle("Bloquear/Desbloquear cliente");
                break;
            ...
            case 2:
                ...
                break;
            case 3:
                this.setTitle("Software Lavandería - Validación");
                listarEmpleados();
                break;
        }
    }
        ...
        for (int i = 0; i < lsEmpleados.size(); i++) {//vaciamos los datos
            if (eleccion == 3) {
                if (lsEmpleados.get(i).getEstado() == 1 && lsEmpleados.get(i).getNivel() == 1) {
                    ...
                    System.out.println(lsEmpleados.get(i).getNombre());
                }
            } else {
    ...
    private void initComponents() {
        ...
        jPanel4.add(txtNombreRecibe, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 210, -1));
        ...
        jPanel4.add(txtContraseña3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 210, -1));
        ...
        jPanel4.add(panelCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 180, 50, 50));
        ...
        jPanel4.add(panelGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 180, 50, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContraseñaConUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ContraseñaConUsuario dialog = new ContraseñaConUsuario(new javax.swing.JFrame(), true);
