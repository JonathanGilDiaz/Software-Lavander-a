 ...
 * @author Jonathan Gil
 */
public class vistaReportesEntregas extends javax.swing.JDialog {
    ...
    public vistaReportesEntregas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        Seticon();
        this.setTitle("Software Lavanderia - Reporte de entregas");
        ...
        TableTotales.getColumnModel().getColumn(8).setCellRenderer(tcr);
    ...
    public void listarPorPeriodoDeFecha() {
        ...
        List<entrega> ListaCl = notaDao.listarNotasEntregasPeriodo(sdf.format(jDateChooser1.getDate()), sdf.format(jDateChooser2.getDate()));
    ...
    public void vaciarATabla(List<entrega> ListaCl) {
        ...
        for (int i = 0; i < ListaCl.size(); i++) {
            for(int m=0; m<lsNotas.size();m++){
                if(lsNotas.get(m).getFolio()==ListaCl.get(i).getIdnota())
                    notaE = lsNotas.get(m);
            }
                  ...
                  Formatter  obj = new Formatter();
                    String horaEntradaB = horaBien.getHours() + ":" +String.format("%0" + 2 + "d", Integer.valueOf(horaBien.getMinutes()));                     
                     ...
                     ob[1] = String.valueOf(notaE.getFolio());
                     ob[2] = notaE.getNombre()+" "+notaE.getApellido();
                     ob[3] =""+"$"+formateador.format(notaE.getVentaTotal());
                     totalVendido=totalVendido+notaE.getVentaTotal();
                     
                    double adeudoN = notaE.getVentaTotal()-notaE.getAnticipo();
                     ob[4] =""+"$"+formateador.format(adeudoN);
                                          totalAdeudo=totalAdeudo+adeudoN;

                     ob[5] =""+"$"+formateador.format(ListaCl.get(i).getPago());;
                     totalCobrado=totalCobrado+ListaCl.get(i).getPago();                    
                                          
                    ob[6] = String.format("%0" + 2 + "d", ListaCl.get(i).getFormaPago());

                    ob[7] =String.format("%0" + 2 + "d", ListaCl.get(i).getIdEmpleado());

                    horaBien = StringADateHora(ListaCl.get(i).getHoraEntrega());
                    obj = new Formatter();
                    horaEntradaB = horaBien.getHours() + ":" +String.format("%0" + 2 + "d", horaBien.getMinutes());                     
                    ob[8] = fechaFormatoCorrecto(ListaCl.get(i).getFechaEntrega())+" "+horaEntradaB;
                       
                    if(!"".equals(ListaCl.get(i).getComentario())){
                        ob[9] = "SI";
                     }else ob[9] = "NO";
        ...
        ob[1] = "";
        ob[2] = "";
        ob[3] = "$"+formateador.format(totalVendido);
        ob[4] = "$" + formateador.format(totalCobrado);
        ob[5] = "$" + formateador.format(totalAdeudo);
        ob[6] = "";
        ob[7] = "";
        ob[8] = "";
        ob[9] = "";
    ...
    private void initComponents() {
        ...
        Titulo.setText("Reporte de entregas");
        ...
        if (TableTotales.getColumnModel().getColumnCount() > 0) {
            TableTotales.getColumnModel().getColumn(0).setPreferredWidth(13);
            TableTotales.getColumnModel().getColumn(1).setPreferredWidth(8);
            TableTotales.getColumnModel().getColumn(2).setPreferredWidth(19);
            TableTotales.getColumnModel().getColumn(3).setPreferredWidth(10);
            TableTotales.getColumnModel().getColumn(4).setPreferredWidth(10);
            TableTotales.getColumnModel().getColumn(5).setPreferredWidth(10);
            TableTotales.getColumnModel().getColumn(6).setPreferredWidth(7);
            TableTotales.getColumnModel().getColumn(7).setPreferredWidth(8);
            TableTotales.getColumnModel().getColumn(8).setPreferredWidth(17);
            TableTotales.getColumnModel().getColumn(9).setPreferredWidth(6);
        }
        ...
        TableLista.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Recepción", "Folio", "Cliente", "Importe", "Anticipo", "Cobro", "Pago", "E", "Entrega", "Det"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false, false, false, false, false, false
        ...
        if (TableLista.getColumnModel().getColumnCount() > 0) {
            TableLista.getColumnModel().getColumn(0).setPreferredWidth(13);
            TableLista.getColumnModel().getColumn(1).setPreferredWidth(8);
            TableLista.getColumnModel().getColumn(2).setPreferredWidth(80);
            TableLista.getColumnModel().getColumn(3).setPreferredWidth(30);
            ...
            TableLista.getColumnModel().getColumn(8).setPreferredWidth(1);
        }
    ...
    private void btnNuevoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNuevoMouseClicked
        ...
        try {
            reporte.reportePDF("Entregas", TableLista, TableTotales, fecha, fecha, "\nREPORTE DE ENTREGAS\n" + tituloEncabezado + "\nFECHA DE EMISION " + DiagHoy);
        } catch (DocumentException ex) {
            Logger.getLogger(vistaReportesEntregas.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModificarMouseClicked
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        reporte.reporteExcel("Entregas", sdf.format(jDateChooser1.getDate()), sdf.format(jDateChooser2.getDate()), TableLista, TableTotales);
        Notification panel = new Notification(new javax.swing.JFrame(), Notification.Type.SUCCESS, Notification.Location.TOP_CENTER, "Generando reporte");
        panel.showNotification();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaReportesEntregas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                vistaReportesEntregas dialog = new vistaReportesEntregas(new javax.swing.JFrame(), true);
