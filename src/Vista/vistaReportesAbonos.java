 ...
 * @author Jonathan Gil
 */
public class vistaReportesAbonos extends javax.swing.JDialog {
    ...
    public vistaReportesAbonos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        Seticon();
        this.setTitle("Software Lavanderia - Reporte de abonos");
    ...
    public void listarPorPeriodoDeFecha() {
        ...
        List<anticipo> ListaCl = anticip.listarAnticipoPeriodo(sdf.format(jDateChooser1.getDate()), sdf.format(jDateChooser2.getDate()));
    ...
    public void vaciarATabla(List<anticipo> ListaCl) {
        ...
        for (int i = 0; i < ListaCl.size(); i++) {
            ...
            adeudoN = notaE.getVentaTotal() - notaE.getAnticipo() - anticip.listarAbonosPorNotaSinFolioActual(notaE.getFolio(), ListaCl.get(i).getId());
            ob[5] = "" + "$" + formateador.format(adeudoN);;
            totalCobrado = totalCobrado + adeudoN;
            ...
            ob[8] = fechaFormatoCorrecto(ListaCl.get(i).getFecha()) + " " + horaEntradaB;

            if (!"".equals(ListaCl.get(i).getObservaciones())) {
                ob[9] = "SI";
            } else {
                ob[9] = "NO";
            }
    ...
    private void initComponents() {
        ...
        Titulo.setText("Reporte de abonos");
        ...
        TableLista.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Recepción", "Folio", "Cliente", "Importe", "Adeudo", "Abono", "Pago", "E", "Abono", "Det"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false, false, false, false, false, false
    ...
    private void btnNuevoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNuevoMouseClicked
        ...
        try {
            reporte.reportePDF("Abonos", TableLista, TableTotales, fecha, fecha, "\nREPORTE DE ABONOS\n" + tituloEncabezado + "\nFECHA DE EMISION " + DiagHoy);
        } catch (DocumentException ex) {
            Logger.getLogger(vistaReportesAbonos.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModificarMouseClicked
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        reporte.reporteExcel("Abonos", sdf.format(jDateChooser1.getDate()), sdf.format(jDateChooser2.getDate()), TableLista, TableTotales);
        Notification panel = new Notification(new javax.swing.JFrame(), Notification.Type.SUCCESS, Notification.Location.TOP_CENTER, "Generando reporte");
        panel.showNotification();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaReportesAbonos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                vistaReportesAbonos dialog = new vistaReportesAbonos(new javax.swing.JFrame(), true);
