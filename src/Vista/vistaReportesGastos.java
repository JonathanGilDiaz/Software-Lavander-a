 ...
 * @author Jonathan Gil
 */
public class vistaReportesGastos extends javax.swing.JDialog {
    ...
    public vistaReportesGastos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        Seticon();
        this.setTitle("Software Lavanderia - Reporte de gastos");
    ...
    public void listarPorPeriodoDeFecha() {
        ...
        List<Gastos> ListaCl = gastos.listarPorFecha(sdf.format(jDateChooser1.getDate()), sdf.format(jDateChooser2.getDate()));
        vaciarATabla(ListaCl);
    }

    public void vaciarATabla(List<Gastos> ListaCl) {
        ...
        for (int i = 0; i < ListaCl.size(); i++) {
            ...
            ob[1] = String.valueOf(ListaCl.get(i).getId());
            ob[2] = ListaCl.get(i).getComprobante();
            ob[3] = ListaCl.get(i).getDescripcion();
            ob[4] = "$" + formateador.format(ListaCl.get(i).getPrecio());;
            totalGastado = totalGastado + ListaCl.get(i).getPrecio();
            ob[5] = String.format("%0" + 2 + "d", ListaCl.get(i).getFormaPago());
        ...
        ob[2] = "";
        ob[3] = "";
        ob[4] = "$" + formateador.format(totalGastado);
        ob[5] = "";
    ...
    private void initComponents() {
        ...
        Titulo.setText("Reporte de gastos");
        ...
        if (TableTotales.getColumnModel().getColumnCount() > 0) {
            TableTotales.getColumnModel().getColumn(0).setPreferredWidth(40);
            TableTotales.getColumnModel().getColumn(1).setPreferredWidth(35);
            TableTotales.getColumnModel().getColumn(2).setPreferredWidth(150);
            TableTotales.getColumnModel().getColumn(3).setPreferredWidth(200);
            TableTotales.getColumnModel().getColumn(4).setPreferredWidth(35);
            TableTotales.getColumnModel().getColumn(5).setPreferredWidth(15);
        }
        ...
        TableLista.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fecha", "Folio", "Comprobante", "Concepto", "Importe", "Fpa"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false, false
        ...
        if (TableLista.getColumnModel().getColumnCount() > 0) {
            ...
            TableLista.getColumnModel().getColumn(1).setPreferredWidth(35);
            TableLista.getColumnModel().getColumn(2).setPreferredWidth(150);
            TableLista.getColumnModel().getColumn(3).setPreferredWidth(200);
            TableLista.getColumnModel().getColumn(4).setPreferredWidth(35);
            TableLista.getColumnModel().getColumn(5).setPreferredWidth(15);
        }
    ...
    private void btnNuevoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNuevoMouseClicked
        ...
        try {
            reporte.reportePDF("Gastos", TableLista, TableTotales, fecha, fecha, "\nREPORTE DE GASTOS\n" + tituloEncabezado + "\nFECHA DE EMISION " + DiagHoy);
        } catch (DocumentException ex) {
            Logger.getLogger(vistaReportesGastos.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModificarMouseClicked
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        reporte.reporteExcel("Gastos", sdf.format(jDateChooser1.getDate()), sdf.format(jDateChooser2.getDate()), TableLista, TableTotales);
        Notification panel = new Notification(new javax.swing.JFrame(), Notification.Type.SUCCESS, Notification.Location.TOP_CENTER, "Generando reporte");
        panel.showNotification();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaReportesGastos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                vistaReportesGastos dialog = new vistaReportesGastos(new javax.swing.JFrame(), true);
