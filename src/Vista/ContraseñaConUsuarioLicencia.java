 ...
 * @author Jonathan Gil
 */
public class ContraseñaConUsuarioLicencia extends javax.swing.JDialog {
    ...
    public ContraseñaConUsuarioLicencia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
     ...
     public void eventoEnter(){
         if(licencia==false){
            ...
            Notification panel = new Notification(new javax.swing.JFrame(), Notification.Type.WARNING, Notification.Location.TOP_CENTER, "Contraseña incorrecta");
             ...
             if("pague renta".equals(txtContraseña3.getText())){
                  contraseñaAceptada=true;
                  dispose();
             }else{
            Notification panel = new Notification(new javax.swing.JFrame(), Notification.Type.WARNING, Notification.Location.TOP_CENTER, "Contraseña incorrecta");
    ...
    private void initComponents() {
        ...
        jPanel4.add(txtContraseña3, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 40, 180, -1));
        ...
        jPanel4.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, -1, 20));
        ...
        jPanel4.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 160, 300, 20));
        ...
        jPanel4.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 42, 70, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContraseñaConUsuarioLicencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ContraseñaConUsuarioLicencia dialog = new ContraseñaConUsuarioLicencia(new javax.swing.JFrame(), true);
