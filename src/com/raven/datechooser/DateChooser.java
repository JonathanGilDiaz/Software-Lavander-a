...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private Date fechaMinima = new Date(1, 11, 31);
    ...
    private void setText(boolean runEvent, int act) {
        if (textRefernce != null) {
            try {
                ...
                System.out.println(date + "------"+ fechaMinima);
                        if(date.after(fechaMinima) || date.equals(fechaMinima)){
                textRefernce.setText(new SimpleDateFormat(dateFormat).format(date));
                 }else{
                              Calendar calendar = Calendar.getInstance();
            ...
            Notification panel = new Notification(new javax.swing.JFrame(), Notification.Type.WARNING, Notification.Location.TOP_CENTER, "La fecha debe ser mayor");
    ...
    public void showPopup() {
        ...
        popup.show(textRefernce, 0, textRefernce.getHeight());
            ...
            System.out.println("se salio, pero tranqui");
        }
    }
    ...
    private void initComponents() {
        ...
        cmdMonth.setFont(new java.awt.Font("Kh Content", 1, 14)); // NOI18N
        ...
        cmdYear.setFont(new java.awt.Font("Kh Content", 1, 14)); // NOI18N
