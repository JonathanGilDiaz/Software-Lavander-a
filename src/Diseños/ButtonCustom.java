...
public class ButtonCustom extends JButton {
    ...
    public enum ButtonStyle {
        PRIMARY(new Color(255, 255, 255), new Color(0,0,0), new Color(2, 111, 82), Color.blue),
        SECONDARY(new Color(204, 204, 255), new Color(204, 204, 255), new Color(204, 204, 255), new Color(204, 204, 255)),
        DESTRUCTIVE(Color.LIGHT_GRAY, new Color(0, 0, 0), new Color(198, 86, 0), Color.blue);
    ...
    public void setEnabled(boolean indicador){
        if(indicador==false) {
